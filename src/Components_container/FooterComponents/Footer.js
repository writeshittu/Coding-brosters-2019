     ...
     return(
        <div className ="container-fluid white bg-navy">
            ...
            <div className="row mt5 tc">
                ...
                <div className="col-sm-3">
                    <h5>Social Media</h5>
                    <svg className="db center pointer link dim h2 w2" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd" 
                   ...
                   <div className="db center pointer link dim h2 w2"> <svg  fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fillRule="evenodd" 
