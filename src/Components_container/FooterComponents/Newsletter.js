    ...
    return(
        <div className ="container-fluid pab0 bg-navy">
            <div className ="row mt3 pa3">
               ...
               <div className="col-7"> <input className="input-reset ba w-70-l fl bg-white pa3 br2-ns br--left-ns" text="email" placeholder="Your Email Address" name="email-address" id="email-address" onChange={onChangeInput} /> </div>
               <button className="col button-reset fl w-100 pa3 ba bg-green hover-bg-light-green white pointer"  id="submit" onClick={onButtonFind}>SUBSCRIBE </button>
            </div>
