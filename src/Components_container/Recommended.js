...
let Recommended = () =>{
    let backgroundImageStyle = {
        backgroundImage:"url(images/bckgrd-image.svg)",
    ...
    return(
        <div className="container-fluid mt-sm-3">
            ...
            <div className="row ma2 pa2 tc">
                <div className= "col-sm-5 pointer grow"><img src= "images/nikeart gallery.svg" alt='nike art gallery' /> </div>
            ...
            <div className="row ma2 pa2 tc">
                <div  className= "col-sm-5 pointer grow"><img src= "images/Zumarock.svg" alt='Zuma Rock'/></div>   
                    <div className= "col-sm-6 ma2 pa2">
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolores, quam modi quisquam eligendi non quia quaerat iusto perferendis 
            ...
            <div style ={backgroundImageStyle} className="row ">
                ...
                <div className="ma5 h5-sn pa2 o-80 bg-navy col-sm-8 f2" ><p className="tc white pa3">"Over 300 places of fun why sit at home and get bored?"</p></div>
            </div>
        </div>
    );
} 
