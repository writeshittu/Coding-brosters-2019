...
const Special = ({pics, title,alt}) => {
    return ( <Fragment>
            ...
            <div className="container shadow sm:shadow-md xl:shadow-2xl md:m-16 xl:m-20  transition duration-500 ease-in-out  transform hover:-translate-y-1 hover:scale-110">
