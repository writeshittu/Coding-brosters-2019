...
const Special = ({pics, title,alt}) => {
    return ( <Fragment>
            ...
            <div className="container shadow sm:shadow-md xl:shadow-2xl md:m-16  xl:m-20 ">
            <div className="md:flex justify-between md:m-6 lg:wrap sm:p-10">
      <div className="mt-4 mdmr-16 md:mt-0 md:ml-6">
         <div className="uppercase tracking-wide text-sm text-indigo-600  my-4 font-bold sm:mt-2">{title} </div>
        ...
        officiis amet ullam ab ipsum neque quisquam!</p>
            ...
            <div className="md:flex-shrink-0">
                  <img className="sm:w-full md:w-56" src={pics} alt={alt} />
            </div>
       </div>
        </div>
