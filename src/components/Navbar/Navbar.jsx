...
const NavBar = () => {
  return (
    <nav className="flex justify-around items-center  flex-wrap bg-white border-b border-black mb-4 fixed ">
      ...
      <div className="w-full block  flex-grow lg:flex lg:items-right lg:w-auto">
        <div className="flex justify-end text-md lg:flex-grow ">
          <Link
            to="/special-offer"
            className="block mt-4 lg:inline-block lg:mt-0 text-black-200  hover:bg-blue-500 py-2 px-2 hover:text-white mr-6"
          >
            Special Offers
          </Link>
          <Link
